	...
	_rules = [...]func() bool{
		...
		func() bool {
			...
			l394:
				...
				depth--
				add(ruleFollowUpRef, position393)
			}
			return true
		},
		...
		func() bool {
			...
			l398:
				depth--
				add(rulePathComponent, position397)
			}
			return true
		l396:
